 ...
 * @LastEditTime : 2024-05-29 15:11:59
 */
import type { Answers, QuestionCollection } from 'inquirer'

import { IdType, RPCType, SelectType } from '../enum'
import { CreateModuleWithCRUDGenerate } from '../generate/create-module-with-crud.generate'
 ...
 *
 */
export class CreateModuleWithCRUDProcess extends BaseProcess {
  ...
  public toNext(options: Answers): BaseProcess | undefined {
    ...
    return new CreateModuleWithCRUDGenerate([...this.options, newOptions])
  }
}
